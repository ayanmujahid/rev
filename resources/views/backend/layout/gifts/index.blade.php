            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Setup your system, please provide your<code>provide your valid data</code>.</p>
...
@push('script')
    ...
    render: function(data, type, full, meta) {
        // Ensure the base URL and image path are concatenated correctly
        return '<img src="' + assetUrl + '/' + data + '" width="250" height="140" alt="Image">';
    }
                        },
                        {
                            data: 'status',
        ...
        function deleteItem(id) {
            let url = '{{ route('gifts.destroy', ':id') }}';
