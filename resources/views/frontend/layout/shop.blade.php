 ...
 <section id="latest-prouduct-area-wrapper" class="latest--prouduct--area--wrapper section--gap">
     <div class="container">
        ...
        <div class="row filter-row">
                <div class="col-md-6">
                    <form id="search-form" action="{{ route('products') }}#shopnow" method="GET">
    <div class="form-group col-md-9">
        <input class="form-control" name="search" type="text" placeholder="Search" value="{{ request()->input('search') }}" />
    </div>
    <div class="form-group col-md-3">
        <button type="submit" class="btn btn-block btn-primary">Search</button>
                ...
                <div class="col-md-6">
                    <form action="{{ route('products') }}#latest-prouduct-area-wrapper" method="GET" class="slct-box">
    <div class="form-group col-md-9">
        <select id="categorySelect" name="category" class="filter-make filter form-control">
...
@endif
    ...
    @php
        ...
        $printifyProducts = Helper::getPrintifyProduct()->data;

        // Filter Printify products based on the search query
        if ($search_query) {
            $printifyProducts = array_filter($printifyProducts, function($printData) use ($search_query) {
                return stripos($printData->title, $search_query) !== false ||
                       stripos($printData->description, $search_query) !== false;
            });
        }
    @endphp

    @foreach ($printifyProducts as $printData)
        <div class="single--pouplar--product">
            <div class="img--wrapper">
            ...
            <div class="product--hover--info">
                <div class="action--button--wrapper">
                    <a data-id="{{ $printData->id . '-' . $printData->variants[0]->id }}" data-type="Printify"
                        data-price="{{ $printData->variants[0]->price / 100 }}"
                        data-image="{{ $printData->images[0]->src }}"
                        data-title="{{ $printData->variants[0]->title }}" data-print_areas=""
                        data-blueprint_id="{{ $printData->blueprint_id }}"
                        data-print_provider_id="{{ $printData->print_provider_id }}" href="javascript:void(0)"
                        data-quantity_limit="{{ $printData->variants[0]->quantity }}"
                        class="cart--btn add_cart">
                ...
                <div class="single--pouplar--product">
                    ...
                    <div class="product--hover--info">
                        ...
                        <h3 class="prod--title product-preview" data-id="{{ $product->id }}" data-type="Shop"
                            ...
                            data-image="{{ Helper::getImage($product->image) }}" data-desc="{{ $product->description }}"
                        ...
                        <div class="inner-col">
                            ...
                            <div class="other-images">
                                        ...
                                        <div class="variations">
                                            <label class="step-label" for="myCheckbox1">
                                                <div class="step-img-holder product-preview"
                                                    ...
                                                    data-title="{{ $response['title'] }}" data-type="Printify"
                                        ...
                                        <div class="variations">
                                            <label class="step-label" for="myCheckbox1">
                                                <div class="step-img-holder product-preview"
                                                    ...
                                                    data-quantity_limit="100" data-title="{{ $response['title'] }}"
                                                    data-image="{{ $response['image'] }}"
                                                    data-desc="{{ $response['description'] }}"
                                ...
                                {{-- <div class="row">
                                    <div class="col-md-3">
                                        <div class="variations">
                                            <input type="checkbox" name="company_type[]" class="step-selective"
                                                value="Agriculture &amp; Outdoor" id="myCheckbox1"
                                    ...
                                    <div class="col-md-3">
                                        <div class="variations">
                                            <input type="checkbox" name="company_type[]" class="step-selective"
                                                value="Art &amp; Photography" id="myCheckbox2">
                                    ...
                                    <div class="col-md-3">
                                        <div class="variations">
                                            <input type="checkbox" name="company_type[]" class="step-selective"
                                                value="Building &amp; Construction" id="myCheckbox3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="variations">
                                            <input type="checkbox" name="company_type[]" class="step-selective"
                                                value="Art &amp; Photography" id="myCheckbox4">
